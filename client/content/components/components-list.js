    ...
    components: [
      {
        ...
        examples:
          "Use buttons as primary actions in forms, dialogs, and cards. Button states reflect interactions: enabled, disabled, hovered, focused, and pressed.",
      ...
      },
      {
        ...
        examples:
          "Use FABs for the primary action in an application or screen.",
    ...
    components: [
      {
        ...
        examples:
          "Use badges to indicate counts of items or notify users of new activity.",
      ...
      },
      {
        ...
        title: "Tooltips",
        description:
          "Display brief labels or messages when users hover over, focus on, or tap an element.",
        features: [
          "Plain text",
          "Rich content",
          "Position variants",
        ...
        examples:
          "Use tooltips to explain the function of interface elements that may need clarification.",
      },
    ],
  },

  {
    ...
    components: [
      ...
      // },
      {
        ...
        examples:
          "Use dialogs to request decisions, show critical information, or focus user attention.",
    ...
    components: [
      {
        ...
        examples:
          "Use checkboxes when users need to select multiple options from a list or toggle a single option on or off.",
      ...
      },
      {
        ...
        examples:
          "Use chips for selections, filtering, or representing small pieces of information.",
        path: "components/chips",
      },
      // {
      //   id: 'date-pickers',
...

  {
    ...
    components: [
      ...
      },
      {
        ...
        examples:
          "Use toasts for non-critical feedback that should not interrupt the user flow.",
      },
    ],
  },
];
