...
const ROUTE_MODULE_MAP = {
  ...
  'components/buttons/button-groups': () => import('../../content/components/buttons/button-groups'),
  'components/buttons/split-button': () => import('../../content/components/buttons/split-button'),
  ...
  'components/carousel': () => import('../../content/components/carousel'),
  ...
  'components/loading-indicator': () => import('../../content/components/loading-indicator'),
  ...
  'components/sheets/bottom': () => import('../../content/components/bottom-sheets'),
  'components/sheets/side': () => import('../../content/components/side-sheets'),
  // former addresses of the same pages
  'components/bottom-sheets': () => import('../../content/components/bottom-sheets'),
  'components/side-sheets': () => import('../../content/components/side-sheets'),
